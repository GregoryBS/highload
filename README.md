...
Так как доступность данных является критически важной для проекта, при их хранении предполагается использовать RAID 10 массив [5,6] из жёстких дисков, что повысит надёжность вследствие полного дублирования данных, а также скорость обработки из-за распараллеливания операций по дискам.
...
5. https://ru.wikipedia.org/wiki/RAID
